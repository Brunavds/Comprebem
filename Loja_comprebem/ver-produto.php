...
?>
        ...
        <div class="corpo-categorias ver-produto">
            <div class="linha">
                ...
                <div class="col-2"> 
                    <img src="assets/img/fla1.avif" alt="Camisa Flamengo" id="produtoImg">
                    ...
                    <div class="img-linha">
                        ...
                        <!--INICIO ITEM GALERIA-->
                     <div class="img-col">
                        <img src="assets/img/fla0.avif" alt="" width="100%" class="produtoMiniatura">
                    </div>
                    <!--FIM ITEM GALERIA-->

                    <!--INICIO ITEM GALERIA-->
                     <div class="img-col">
                        <img src="assets/img/fla2.avif" alt="" width="100%" class="produtoMiniatura">
                    </div>
                    <!--FIM ITEM GALERIA-->

                    <!--INICIO ITEM GALERIA-->
                    <div class="img-col">
                        <img src="assets/img/fla3.avif" alt="" width="100%" class="produtoMiniatura">
                    </div>
                    <!--FIM ITEM GALERIA-->

                    <!--INICIO ITEM GALERIA-->
                    <div class="img-col">
                        <img src="assets/img/fla1.avif" alt="" width="100%" class="produtoMiniatura">
                    </div>
                    <!--FIM ITEM GALERIA-->
                ...
                <div class="col-2">
                    <P>Camisa do Flamengo II 23 Masculina adidas</P>
